...
app.layout = dbc.Container(
    [
        ...
        dcc.Store(id="session3", storage_type="session"),
        dcc.Store(id="session4", storage_type="session"),
...
def generate_graphs(n, ismade, data2, distances, input, iszip):
    ...
    figdict = {
        "Full Term Dataset": [figl[15], figl[0], figl[5], figl[10]],
        "100-Topic Dataset": [figl[16], figl[1], figl[6], figl[11]],
        "200-Topic Dataset": [figl[17], figl[2], figl[7], figl[12]],
        "400-Topic Dataset": [figl[18], figl[3], figl[8], figl[13]],
        "50-Topic Dataset": [figl[19], figl[4], figl[9], figl[14]],
    }
