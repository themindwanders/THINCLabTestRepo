...
expName = 'Finger_tapping_5mins_15s_on_15s_off'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Ian\\Documents\\TaskRepo\\Basic_fMRI_Test_programs\\Finger_tapping_5mins_15s_on_15s_off_lastrun.py',
...
text = visual.TextStim(win=win, name='text',
    text="The program is now ready and will be triggered automatically by the scanner. Press 't' to proceed manually (e.g. for demo purposes).",
    font='Arial',
